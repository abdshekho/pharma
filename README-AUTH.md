...
- `DELETE /users/:id` - حذف المستخدم (Admin فقط)
...
## مثال على تحديث المستخدم

```json
PUT /users/:id
{
  "fullName": "د. أحمد محمد الجديد",
  "phone": "+963987654321"
}
```

**ملاحظة:** لا يمكن للمستخدم تعديل `status` أو `role` - هذه الصلاحيات محجوزة للـ Admin فقط.
